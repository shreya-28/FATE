...
iplist=(A.F-ip A.MS-ip A.P-ip A.R-ip A.S-ip A.E-ip B.F-ip A.B-ip B.MS-ip B.P-ip B.R-ip B.S-ip B.E-ip B.B-ip)
iplist0=(A.F-ip A.MS-ip A.P-ip A.R-ip A.S-ip A.E-ip A.B-ip)
iplist1=(B.F-ip B.MS-ip B.P-ip B.R-ip B.S-ip B.E-ip B.B-ip)
fateboard0=(A.B-ip)
fateboard1=(B.B-ip)
eggautocompile=true
